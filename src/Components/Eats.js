...
class EatsPage extends Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    return(
      <div style={{backgroundColor: "#FF2A00"}}>
        <Navbar>
          <Navbar.Header>
            <Navbar.Brand>
        ...
        <ReactPlayer style={{position:'fixed', minWidth: '100%', minHeight: '91%', height: 'auto', width: 'auto', backgroundSize: 'cover'}} playing loop url="https://www.youtube.com/watch?v=nrkLO1oWMzM"/>
      </div>
    );
  }
}
